...
/*!
 @method stepToWaitForNotificationName:object:whileExecutingStep:
 @abstract A step that waits for an NSNotification emitted during execution of a child step. In addition, you can use the shouldContinueWaitingBlock to decide if the notification fired should finish the step, or if you would like to wait for another one.
 @discussion Useful when step execution causes a notification to be emitted, but executes too quickly for stepToWaitForNotificationName: to observe it.
 An observer will be registered for the notification before the observedStep is executed.
 @param name The name of the NSNotification
 @param object The object to which the step should listen. Nil value will listen to all objects.
 @param block to determine if you would like to continue waiting.
 @result A configured test step.
 */
+ (id)stepToWaitForNotificationName:(NSString *)name object:(id)object whileExecutingStep:(KIFTestStep *)childStep shouldContinueWaiting:(BOOL(^)(NSNotification * notification))shouldContinueWaiting;
...
/*!
 @method stepsToChangeToAndWaitForDeviceOrientation:
 @abstract A step that simulates a change to the device's user interface orientation, and then waits to ensure the change was successful.
 @discussion These steps rely on a private Apple API call that might change in future versions of the operating system.
...
/*!
 @method stepToChangeToDeviceOrientation:
...
/*!
 @method stepToWaitForDeviceOrientation:
 @abstract A step that waits for a change to the device's user interface orientation.
 @param newOrientation The orientation to wait for.
 @result A configured test step.
 */
